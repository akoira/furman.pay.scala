...
angular.module('myApp.orders', ['ngRoute', 'ui.grid', 'ui.grid.edit', 'ui.grid.rowEdit', 'ui.grid.cellNav', 'ui.grid.resizeColumns', 'ui.grid.pinning', 'ui.grid.selection'])
    ...
    .controller('OrdersCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.gridOptions.data = generateData();
